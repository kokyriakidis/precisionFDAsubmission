...
SAMPLENAME="HG003"
SUBMISSION="K33QJ"
FQ1FILEPATH="path/to/HG003.novaseq.pcr-free.35x.R1.fastq.gz"
FQ2FILEPATH="path/to/HG003.novaseq.pcr-free.35x.R2.fastq.gz"
NTHREADS=18
...
--reads ${WORKDIR}/${SUBMISSION}/BWA/${SAMPLENAME}-${SUBMISSION}-sorted-markdup.bam \
